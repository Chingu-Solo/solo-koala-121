...
function displayListGrid() {
  var elDisplay = document.getElementById("list").style.display;
  if ( elDisplay == "none") {
...
// font size
function FontSize() {
  var FontSizeSelect = document.getElementById("font_size").selectedIndex;
  var sizes = document.getElementsByTagName("option")[FontSizeSelect].value
  var getFontSize = document.getElementsByClassName("text")
